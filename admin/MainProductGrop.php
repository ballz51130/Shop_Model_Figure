...
session_start(); 
if(isset($_GET['G_ID']))  {   
    $sql = "DELETE FROM group_tb WHERE G_ID = '".$_GET['G_ID']."'";
    $query= $conn->query($sql);
    if($query){
        echo '<script type="text/javascript">alert("บันทึกสำเร็จ");</script>';
        echo"<META HTTP-EQUIV ='Refresh' CONTENT = '1;URL=./MainProductGrop.php'>";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">รายการประเภทสินค้า</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <div class="maimMenu">
                            <a class="btn btn-primary" style="float:left; margin-left:50px;margin:10px"
                                href="./insert/addGroup.php">เพิ่มประเภทสินค้า</a>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td scope="col"><?php echo $result['G_Name'];?></td>
                                        <td scope="col"><img src="<?php echo '../photo/model/'.$result['G_Photo'] ;?>"
                                                width="50px" height="50px"></td>
                                        <td scope="col"><?php echo $status;?></td>
                                        <td scope="col"> <a
                                                href="./edit/EditGroup.php?G_ID=<?php echo $result['G_ID'];?>"><img src="../photo/edit.png" width="20px" hight="20px"></a></td>
                                        <td scope="col"><a
                                                href="./MainProductGrop.php?G_ID=<?php echo $result['G_ID'] ;?>"onclick="return confirm('คุณต้องการลบรายการนื้หรือไม่ ?')"><img src="../photo/trash.png" width="20px" hight="20px" ></a></td>
                                    </tr>
                                    <?php 
                    $count++;
                    } ?>
