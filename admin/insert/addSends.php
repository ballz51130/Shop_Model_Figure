    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">เพิ่มช่องทางการส่งของ</h1>
          </div>
          <!-- Content Row -->
          <div class="row">
            <!-- เนื้อหา -->
            <div class="data">
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="Sn_Name" value="" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">ราคา</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="Sn_Price" value="" required>
                  </div>
                </div>
                  <div class="form-group row">
