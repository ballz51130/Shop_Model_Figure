...
// image file directory 
$target = "../../photo/Order/".basename($image);
$sql ="INSERT INTO product(P_ID,P_Number, P_Name, P_Price, P_Detel,P_weight,P_Photo, P_Status, P_Group,P_Brand) 
VALUES ('".$_POST['P_ID']."','".$_POST['P_Number']."','".$_POST['P_Name']."','".$_POST['P_Price']."','$image_text','".$_POST['P_weight']."','$image','".$_POST['P_Status']."','".$_POST['P_Group']."','".$_POST['P_Brand']."')";
//execute query
mysqli_query($conn, $sql);
...
move_uploaded_file($_FILES['image3']['tmp_name'], $target3);
mysqli_query($conn, $sql2);
// insert PreOrder Detail
$sqlPre = "INSERT INTO preorder(P_Number,Pre_Month, Pre_Comin) VALUES ('".$_POST['P_Number']."','".$_POST['Pre_Month']."','".$_POST['Pre_Comin']."')";
mysqli_query($conn, $sqlPre);
if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  echo" <center> <h1 color='green'> อัพโหลด สำเร็จ </h1> </center>";
  echo"<META HTTP-EQUIV ='Refresh' CONTENT = '2;URL= ./addProduct.php'>";
