            ...
            <div class="data">
              <form action="./checkadd.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">รหัสสินค้า</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="P_Number" value="" pattern="[A-Za-z0-9]{5,11}"  title="กรุณาใส่มากว่า5ตัวอักษร" required oninvalid="this.setCustomValidity('กรุณาใส่ข้อมูลเฉพาะ a-z 0-9 และต้องมากว่า5ตัวอัพษร')" oninput="this.setCustomValidity('')"> 
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-3 col-form-label">ชื่อสินค้า</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputPassword3" name="P_Name" value="" pattern="[A-Za-z0-9ก-๑\s]{5,}" title="กรุณาใส่มากว่า5ตัวอักษร"  required oninvalid="this.setCustomValidity('กรุณาใส่ข้อความมากว่า5ตัวอัพษร')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">รูปหลักสินค้า</label>
                  <div class="col-sm-3">
                    <input type="file"  name="image" accept=".jpg, .jpeg, .png"  required oninvalid="this.setCustomValidity('กรุณาเพิ่มรูปภาพ')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">รูปรายระเอียด1</label>
                  <div class="col-sm-3">
                    <input type="file"  name="image1" accept=".jpg, .jpeg, .png"  required oninvalid="this.setCustomValidity('กรุณาเพิ่มรูปภาพ')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">รูปรายระเอียด2</label>
                  <div class="col-sm-3">
                    <input type="file"  name="image2" accept=".jpg, .jpeg, .png"  required oninvalid="this.setCustomValidity('กรุณาเพิ่มรูปภาพ')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">รูปรายระเอียด3</label>
                  <div class="col-sm-3">
                    <input type="file"  name="image3" accept=".jpg, .jpeg, .png"  required oninvalid="this.setCustomValidity('กรุณาเพิ่มรูปภาพ')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">น้ำหนัก(กรัม)</label>
                  <div class="col-sm-6">
                    <input type="number" class="form-control" id="inputtext" name="P_weight" value="" min="1"  max="9999" title="ตัวเลขต้องมากกว่า 0 น้อยกว่า 11 หลัก"   required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลในช่องนี้')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">แบรนด์สินค้า</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="P_Brand" value=""  required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลในช่องนี้')" oninput="this.setCustomValidity('')">
                  </div>
                  </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">จำนวน</label>
                  <div class="col-sm-6">
                    <input type="number" class="form-control" id="inputtext" name="P_Unit" value="" min="1" max="99" required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลในช่องนี้')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">ราคาต้นทุน</label>
                  <div class="col-sm-6">
                    <input type="number"  class="form-control" id="inputtext" name="P_Pricebye" value="" min="1" max="9999999" required oninvalid="this.setCustomValidity('ราคาสินค้าไม่ถูกต้อง')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-3 col-form-label">ราคาขาย</label>
                  <div class="col-sm-6">
                    <input type="number"  class="form-control" id="inputtext" name="P_Price" value="" min="1" max="9999999" required oninvalid="this.setCustomValidity('ราคาสินค้าไม่ถูกต้อง')" oninput="this.setCustomValidity('')">
                  </div>
                </div>
               <input type="hidden" name="P_Status" value="1">
                <div class="form-group row">
                <label for="inputtext" class="col-sm-3 col-form-label">ประเภท</label>
                <div class="col-sm-6">
                <select id="P_Group" name="P_Group" class="form-control" required oninvalid="this.setCustomValidity('กรุณาเลือกข้อมูลในช่องนี้')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="addStatus" style="position: absolute; margin-left:300px;margin-top:-35px;">
                    <a href="../insert/addGroup.php" class="btn btn-primary">เพิ่ม</a>
                    </div>
                    </div>
                </div>
                <div class="col-sm-12">
