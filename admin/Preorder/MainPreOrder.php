        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">รายการสินค้าPreOrder</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <div class="maimMenu">
                                <a class="btn btn-primary" style="float:left; margin-left:50px;margin:10px"
                                href="../insert/addPreProduct.php">เพิ่มสินค้าPreOrder</a> <br> <br> 
                                <br>
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td scope="col"><a
                                                href="../del/delProduct.php?ID=<?php echo $result['P_ID'] ;?>"onclick="return confirm('คุณต้องการลบรายการนื้หรือไม่ ?')"><img src="../../photo/trash.png" width="20px" hight="20px"></a></td>
                                    </tr>
                                    <?php 
                    $count++;
                    } ?>
