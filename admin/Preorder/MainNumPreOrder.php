        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">รายการPreOrder</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <div class="product">
                        <div class="table">
                                ...
                                $num = 1;
                                if($resultcheck == ""){
                                    echo "<span style='font-size:30px;margin-left:250px;margin-top:-50px;position: absolute;'>ไม่พบรายการสินค้าค้างส่ง</span>";
                                }
                                if($resultcheck > 0){
                                ...
                                <?php } ?>  <!-- if $resultcheck -->
                                <?php if($resultcheck= "") { echo "<p style='margin-left:300px;font-size:30px;'>ไม่พบข้อมูล</p>";}?>
