...
session_start(); 
$sqlre = "SELECT orders.O_ID,user.U_Name,product.P_Name,P_ID,orderdetail.OD_Unit,product.P_Price,product.P_Photo,send_tb.Sn_Price,bank_tb.Bk_Name,Bk_Number,orders.C_ID,
