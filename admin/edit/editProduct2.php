    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <!-- เนื้อหา -->
            <div class="data">
              <form action="./CheckEdit2.php" method="POST" enctype="multipart/form-data">
              <div class="photo"  style="margin-left:120px; ">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputtext" name="P_Number" value="<?php echo $result['P_Number'] ?>"disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">ชื่อสินค้า</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPassword3" name="P_Name" value="<?php echo $result['P_Name'] ?>"disabled>
                  </div>
                </div>
                <div class="inputphoto">
                  <label for="Name">รายระเอียดสินค้า</label>
                  <div>
                    <textarea id="text" cols="20" rows="6" name="P_Detel" class="form-control" disabled> <?php echo $result['P_Detel'] ?> </textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-2 col-form-label">น้ำหนัก</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputtext" name="P_weight" value="<?php echo $result['P_weight'] ?>"disabled>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputtext" name="P_Pricebye" value="<?php echo $result['P_Purchaseprice'] ?>"disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-2 col-form-label">ราคาขาย</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputtext" name="P_Price" value="<?php echo $result['P_Price'] ?>"disabled>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-2 col-form-label">สถานะสินค้า</label>
                  <div class="col-sm-8">
                    <select id="P_Status" name="P_Status" class="form-control" disabled>
                ...
                <div class="col-sm-8">
                <select id="P_Group" name="P_Group" class="form-control"disabled>
