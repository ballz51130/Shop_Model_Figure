...
if(isset($_POST['submit'])){
    if($image = $_FILES['image']['name'] != ""){
        ...
        if($query||$move){
            ...
            echo"<META HTTP-EQUIV ='Refresh' CONTENT = '0;URL=../MainBank.php'>";
          ...
          <div class="row">
            ...
            <div class="data">
              <form action="" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="Bk_id" value="<?php echo $result['Bk_id'] ?>">
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">ชื่อธนคาร</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="Bk_Name" value="<?php echo $result['Bk_Name'] ?>" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">ชื่อบัญชี</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="U_Name" value="<?php echo $result['U_Name'] ?>" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">หมายเลขบัญชี</label>
                  <div class="col-sm-6">
                    <input type="number" class="form-control" id="inputtext" name="Bk_Number" value="<?php echo $result['Bk_Number'] ?>" required>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <?php if($result['Bk_Type']==1){
                     $status = "Show" ;
                    }else{

                      $status = "Hidden";}
                  ?>
                  <option value="<?php echo $result['Bk_Type'];?>"><?php echo $status; ?></option>
                  <option value="1">Show</option>
                  <option value="2">Hidden</option>
                  </select>
                  <p> *ใช้โชว์ในการชำระเงินของลูกค้า</p>
                  </div>
