...
if(isset($_POST['submit'])){
       ...
       $query= $conn->query($sql);
        if($query){
            ...
            echo"<META HTTP-EQUIV ='Refresh' CONTENT = '0;URL=../MainEMS.php'>";
        }
        else{
          ...
          <div class="row">
            ...
            <div class="data">
              <form action="" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="Bk_id" value="<?php echo $result['Sn_id'] ?>">
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">ชื่อบริษัทขนส่ง</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="Sn_Name" value="<?php echo $result['Sn_Name'] ?>" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">ราคา</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="inputtext" name="Sn_Price" value="<?php echo $result['Sn_Price'] ?>" required>
                  </div>
                </div>
                  <div class="form-group row">
                  <label for="inputtext" class="col-sm-4 col-form-label">สถานะ</label>
                  <div class="col-sm-8">
                  <select name="Sn_Status" required>
                  <?php if($result['Sn_Status']==1){
                     $status = "Show" ;
                    }else{

                      $status = "Hidden";}
                  ?>
                  <option value="<?php echo $result['Sn_Status'];?>"><?php echo $status; ?></option>
