...
if(isset($_GET['Bk_id']))  {   
    ...
    $sql = "DELETE FROM bank_tb WHERE Bk_id = '$bk_id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">จัดการธนคาร</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <div class="maimMenu">
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td scope="col"> <a
                                                href="./edit/EditBank.php?Bk_id=<?php echo $result['Bk_id'];?>"><img src="../photo/edit.png" width="20px" hight="20px"></a></td>
                                        <td scope="col"><a
                                                href="./MainBank.php?Bk_id=<?php echo $result['Bk_id'] ;?>"onclick="return confirm('คุณต้องการลบรายการนื้หรือไม่ ?')"><img src="../photo/trash.png" width="20px" hight="20px"></a></td>
                                    </tr>
                                    <?php 
                    $count++;
                    } ?>
