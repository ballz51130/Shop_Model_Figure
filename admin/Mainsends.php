        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">รายการสินค้าค้างส่ง</h1>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <div class="product">
                        ...
                        <div class="table">
                                <?php 
                                $sqlOrder = "SELECT orders.O_ID, orderdetail.P_Number,orders.O_Status,orders.C_ID,product.P_Name,product.P_Status,user.U_ID,user.U_Name,orderdetail.OD_Unit,product.P_Price,orders.O_Status,Sn_Name
                                ...
                                if($resultcheck['OUnit'] ==0){
                                    echo "<span style='font-size:30px;margin-left:250px;margin-top:-150px;position: absolute;'>ไม่พบรายการสินค้าค้างส่ง</span>";
                                }
                                else{
                                if($resultcheck>0){
                                ?>
                                ...
                                <?php } ?>  <!-- if $resultcheck -->
                                <?php if($resultcheck <1) { echo "<span style='font-size:30px;margin-left:250px;margin-top:-150px;position: absolute;'>ไม่พบรายการสินค้าค้างส่ง</span>";}}?>
