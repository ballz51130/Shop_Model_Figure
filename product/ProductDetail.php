    ...
    <div class="contriner">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="social">
                        ...
                        <li class="market_u"><a href="http://">|<img src="../photo/supermarket.png" width="30px"
                                    hight="30px">|<span class="badge badge-primary badge-pill"
                                    style="color:blue;"><?php echo $rowN;?></span></a></li>
                    </ul>
                </div>
            </div>
            <div class="list">
        ...
        <div class="product">
            <div class="sidebar">
                ...
                <a href="./product/MainProduct.php?pages=gundum" class="btn btn-primary">Gundum Wing</a> <br>
