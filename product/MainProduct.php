    ...
    <div class="contriner">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="social">
                        ...
                        <li class="market_u"><a href="../main/user.php">|<img src="../photo/supermarket.png"
        ...
        <div class="product">
            <div class="sidebar">
                ...
                <a href="../product/MainProduct.php?Group=Gundum" class="btn btn-primary">Gundum Wing</a> <br>
                <a href="../product/MainProduct.php?Group=Vocaloid" class="btn btn-primary">Hatsune Miku</a> <br>
                <a href="../product/MainProduct.php?Group=Naruto" class="btn btn-primary">Naruto</a> <br>
                <a href="../product/MainProduct.php?Group=OnePiece" class="btn btn-primary">One Piece</a> <br>
