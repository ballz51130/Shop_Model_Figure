        ...
        <div class="manu_login">
            <ul>
               ...
               <li> <?php if($_SESSION['login'] == ""){ ?>
                       ...
                       <a onclick="return confirm('คุณต้องการออกจากระบบหรือไม่')" href="../login/logout.php?pages=<?php echo $pages ?>">Logout</a>
                            <?php } ?>        
                             ...
                             <form method="post" action="./order/InsertOrder.php">  
                              <div class="card" style=" width: 100% ;background-color:#D8FFFB; padding:20px;" align="center">
                                    ...
                                    <?php if($_SESSION['login'] == ""){ ?>
                                       <a href="../login/login.php?pages=<?php echo $pages ?>"> <input name="add_to_cart" class="btn btn-success" value="เพื่มเข้าตระกร้า" onclick="return confirm('กรุณา Login ก่อนทำหารสั่งซื้อ')"> </a>
