...
$target3 = "../photo/ReProduct/".basename($image3);
    $sql = "INSERT INTO returnorder(U_ID,O_ID, Re_feedback, Re_Detail, Re_Status, Re_NameBank, Re_NumberBank, Re_Date) VALUES ('".$_SESSION['User']."','".$_POST['O_ID']."','".$_POST['Re_feedback']."','".$_POST['Re_Detail']."','รอตรวจสอบ(สินค้า)','".$_POST['Re_NameBank']."','".$_POST['Re_NumberBank']."',NOW())";
