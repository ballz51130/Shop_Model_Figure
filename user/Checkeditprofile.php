...
if($_POST['U_Password']==""){ // pass no change 
    ...
    $sqledit = "UPDATE user SET U_UserName='".$_POST['U_UserName']."',U_Name='".$_POST['U_Name']."',Home='".$_POST['Home']."',T_District='".$row['DISTRICT_NAME']."',A_District='".$row['AMPHUR_NAME']."',Province='".$row['PROVINCE_NAME']."',zip='".$_POST['zip']."',U_Phone='".$_POST['U_Phone']."',U_Photo='$image',U_Email='".$_POST['Email']."' WHERE U_ID='".$_POST['U_ID']."'";
     $query = mysqli_query($conn,$sqledit);
     move_uploaded_file($_FILES['image']['tmp_name'], $target);
     if($_SESSION['User'] == '1'){
        if($query){
    ...
    $queryHone = mysqli_query($conn,$sqlHome);
    $row = mysqli_fetch_array($queryHone);
    $sqledit = "UPDATE user SET U_UserName='".$_POST['U_UserName']."',U_Password='$pass',U_Name='".$_POST['U_Name']."',Home='".$_POST['Home']."',T_District='".$row['DISTRICT_NAME']."',A_District='".$row['AMPHUR_NAME']."',Province='".$row['PROVINCE_NAME']."',zip='".$_POST['zip']."',U_Phone='".$_POST['U_Phone']."',U_Photo='$image',U_Email='".$_POST['Email']."' WHERE U_ID='".$_POST['U_ID']."'";
     move_uploaded_file($_FILES['image']['tmp_name'], $target);
     $query = mysqli_query($conn,$sqledit);
     if($_SESSION['User'] == '1'){
        if($query){
    ...
    if($_POST['U_Password']==""){ // pass no change 
        ...
        $queryHone = mysqli_query($conn,$sqlHome);
        $row = mysqli_fetch_array($queryHone);
        $sqledit = "UPDATE user SET U_UserName='".$_POST['U_UserName']."',U_Name='".$_POST['U_Name']."',Home='".$_POST['Home']."',T_District='".$row['DISTRICT_NAME']."',A_District='".$row['AMPHUR_NAME']."',Province='".$row['PROVINCE_NAME']."',zip='".$_POST['zip']."',U_Phone='".$_POST['U_Phone']."',U_Email='".$_POST['Email']."' WHERE U_ID='".$_POST['U_ID']."'";
         $query = mysqli_query($conn,$sqledit);
         if($_SESSION['User'] == '1'){
            if($query){
                echo '<script type="text/javascript">alert("บันทึกสำเร็จ");</script>';
        ...
        $queryHone = mysqli_query($conn,$sqlHome);
        $row = mysqli_fetch_array($queryHone);
        $sqledit = "UPDATE user SET U_UserName='".$_POST['U_UserName']."',U_Password='$pass',U_Name='".$_POST['U_Name']."',Home='".$_POST['Home']."',T_District='".$row['DISTRICT_NAME']."',A_District='".$row['AMPHUR_NAME']."',Province='".$row['PROVINCE_NAME']."',zip='".$_POST['zip']."',U_Phone='".$_POST['U_Phone']."',U_Email='".$_POST['Email']."' WHERE U_ID='".$_POST['U_ID']."'";
         $query = mysqli_query($conn,$sqledit);
         if($_SESSION['User'] == '1'){
            if($query){
                echo '<script type="text/javascript">alert("บันทึกสำเร็จ");</script>';
