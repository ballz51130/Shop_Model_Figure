  ...
  <div class="contriner" style="width:900px;">
    <form action="./CheckEdit.php" method="POST">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputEmail3" name="U_UserName"
            value="<?php echo $result['U_UserName'];?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="inputPassword3" class="col-sm-2 col-form-label">ชื่อสินค้า</label>
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputPassword3" name="U_Password"
            value="<?php echo $result['U_Password'];?>">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputEmail3" name="P_Unit"
            value="<?php echo $result['P_Unit'];?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="inputEmail3" class="col-sm-2 col-form-label">ราคาสินค้า</label>
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputEmail3" name="P_Price"
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputEmail3" name="P_Status"
            value="<?php echo $result['P_Status'];?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="inputEmail3" class="col-sm-2 col-form-label">ประเภทสินค้า(กลุ่ม)</label>
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputEmail3" name="P_Group"
            value="<?php echo $result['P_Group'];?>">
        </div>
      </div>
      <div class="col-sm-10">
